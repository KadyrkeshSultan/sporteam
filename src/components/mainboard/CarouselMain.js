      ...
      <div ><br />
        ...
        <Carousel showArrows={true} autoPlay={true} showThumbs={false} dynamicHeight={false} useKeyboardArrows={true} swipeable={true} emulateTouch={true} showStatus={false} infiniteLoop>
          <div >
            ...
            <p className="legend" style={styles}>Заголовок новости 1</p>
          </div>
          <div>
          <img src="https://itd2.mycdn.me/image?id=850604732307&t=20&plc=WEB&tkn=*wBRLLaXtkm34eqMg1mSbUIPEvO0" style={{height:'300px',objectFit:'cover'}}/>
            <p className="legend" style={styles}>Заголовок новости 2</p>
          </div>
          <div>
          <img src="https://itd2.mycdn.me/image?id=850604732307&t=20&plc=WEB&tkn=*wBRLLaXtkm34eqMg1mSbUIPEvO0" style={{height:'300px',objectFit:'cover'}}/>
            <p className="legend" style={styles}>Заголовок новости 3</p>
          </div>
          <div>
          <img src="https://itd2.mycdn.me/image?id=850604732307&t=20&plc=WEB&tkn=*wBRLLaXtkm34eqMg1mSbUIPEvO0" style={{height:'300px',objectFit:'cover'}}/>
            <p className="legend" style={styles}>Заголовок новости 4</p>
          </div>
          <div>
          <img src="https://itd2.mycdn.me/image?id=850604732307&t=20&plc=WEB&tkn=*wBRLLaXtkm34eqMg1mSbUIPEvO0" style={{height:'300px',objectFit:'cover'}}/>
            <p className="legend" style={styles}>Заголовок новости 5</p>
          </div>
          <div>
          <img src="https://itd2.mycdn.me/image?id=850604732307&t=20&plc=WEB&tkn=*wBRLLaXtkm34eqMg1mSbUIPEvO0" style={{height:'300px',objectFit:'cover'}}/>
            <p className="legend" style={styles}>Заголовок новости 6</p>
          </div>
        </Carousel>
      </div >
    );
